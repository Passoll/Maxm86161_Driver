...
sl_status_t maxm86161_init_device(maxm86161_device_config_t global_cfg)
{
  ...
  ret = static_cast<sl_status_t>(ret | maxm86161_ppg_config(&global_cfg.ppg_cfg));
  ret = static_cast<sl_status_t>(ret | maxm86161_led_sequence_config(&global_cfg.ledsq_cfg));
  ret = static_cast<sl_status_t>(ret | maxm86161_interupt_control(&global_cfg.int_cfg));
